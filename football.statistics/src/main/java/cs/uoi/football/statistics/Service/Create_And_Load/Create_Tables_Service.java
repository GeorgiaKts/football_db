...
@Service
public class Create_Tables_Service {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    // Method to execute SQL to create tables
    public void createTables() {
        ...
        String createCountriesTableSQL = "CREATE TABLE IF NOT EXISTS countries ("
                ...
                + "INDEX idx_id_countries (id_countries)) ENGINE=InnoDB;";
        ...
        String createTeamsTableSQL = "CREATE TABLE IF NOT EXISTS teams ("
                ...
                + "INDEX idx_country_id (id_countries), "
                + "INDEX idx_team (team)) ENGINE=InnoDB;";

        String createFormerNamesTableSQL = "CREATE TABLE IF NOT EXISTS former_names ("
                ...
                + "FOREIGN KEY (id_teams) REFERENCES teams(id_teams) ON DELETE SET NULL ON UPDATE CASCADE) ENGINE=InnoDB;";
        ...
        String createResultsTableSQL = "CREATE TABLE IF NOT EXISTS results ("
                ...
                + "INDEX idx_away_team (away_team)) ENGINE=InnoDB;";

        String createShootoutsTableSQL = "CREATE TABLE IF NOT EXISTS shootouts ("
                + "date DATE NOT NULL, "
                + "home_team VARCHAR(255) NOT NULL, "
                + "away_team VARCHAR(255) NOT NULL, "
                ...
                + "FOREIGN KEY (id_results) REFERENCES results(id_results) ON DELETE SET NULL ON UPDATE CASCADE) ENGINE=InnoDB;";

        String createGoalscorersTableSQL = "CREATE TABLE IF NOT EXISTS goalscorers ("
                ...
                + "INDEX idx_year (date)) ENGINE=InnoDB;";

        // Execute SQL commands to create tables
        jdbcTemplate.execute(createCountriesTableSQL);
        jdbcTemplate.execute(createTeamsTableSQL);
        jdbcTemplate.execute(createFormerNamesTableSQL);
        jdbcTemplate.execute(createResultsTableSQL);
        jdbcTemplate.execute(createShootoutsTableSQL);
        jdbcTemplate.execute(createGoalscorersTableSQL);
    }
}
